...
public class SecurityConfig {
    ...
    private static final String REALM_ACCESS_CLAIM = "realm-access";
    ...
    public SecurityFilterChain resourceServerFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> auth
                .requestMatchers(new AntPathRequestMatcher("/users*", HttpMethod.OPTIONS.name()))
                .permitAll()
        ...
        return authorities -> {
            ...
            if (isOidc) {
                ...
                if (userAttributes.containsKey(REALM_ACCESS_CLAIM)) {
                    ...
                    Collection<String> roles = (Collection<String>) realmAccess.get(REALM_ACCESS_CLAIM);
                    mappedAuthorities.addAll(generateAuthoritiesFromClaim(roles));
                }
            }
